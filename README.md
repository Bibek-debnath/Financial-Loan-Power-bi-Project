# Financial-Loan-Power-bi-Project
Introduction

In today’s world, banks and financial companies give loans to people for many reasons such as buying a car, paying credit card bills, education, medical needs, or debt consolidation. Managing thousands of loans is not easy because companies must make sure that people repay their loans on time. If many customers fail to repay, the company may face heavy losses.

This project is based on financial loan data analysis, where I studied customer loan information to understand loan behavior, repayment status, risk factors, and trends. I used Power BI to create an interactive dashboard that clearly shows important loan insights. This project helps financial institutions take better decisions and reduce risk.

📌 Objective of the Project

The main aim of this project is to understand how loans are performing and to answer important business questions such as:

How many loans are fully paid and how many are charged off?

Which loan purpose has the highest loan amount?

Which loan term (36 months or 60 months) is safer?

How does customer income affect loan repayment?

In which months are loans taken the most?

By answering these questions, banks can improve loan approval policies and manage risks better.

📌 Dataset Description

The dataset used in this project contains detailed information about loan applicants and their loan status. Each row represents one loan record.
...
This data helps in understanding both customer behavior and loan performance.

📌 Tools Used

To complete this project, I used the following tools:

Microsoft Excel for cleaning and formatting the data

MySQL for analyzing and querying the data

Power BI for creating dashboards and visualizations

GitHub for project documentation and sharing my work

📌 Dashboard Overview

The Power BI dashboard shows the complete picture of loan performance using charts, graphs, and KPIs. At the top of the dashboard, important values such as Total Loans, Total Loan Amount, Total Payment, and Total Annual Income are displayed.
...
Most loans are fully paid, showing a strong and healthy loan portfolio.

Short-term loans are safer and more profitable.

Debt consolidation is the most common loan purpose.

Income verification reduces the chances of loan default.

Loan demand increases during certain months of the year.

📌 Business Recommendations

Based on the analysis, the following recommendations can be made:

Banks should focus more on 36-month loan plans.

Proper income verification should be made compulsory.

Extra attention should be given to customers with a high risk of default.

Loan campaigns can be planned during peak months.

Special products can be designed for debt consolidation customers.

📌 Conclusion

This Financial Loan Analysis project shows how data analysis and visualization can help financial institutions make better decisions. By using Power BI, large and complex data is converted into easy-to-understand insights.
